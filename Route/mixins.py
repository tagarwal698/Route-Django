...
def RedirectParams(**kwargs):
	...
	# Appends url parameters when redirecting users 
...
def Directions(*args, **kwargs):
	...
	# for handling directions from google

	lat_a = kwargs.get("lat_a")		#lat_a and long_a are for origin
	long_a = kwargs.get("long_a")
	lat_b = kwargs.get("lat_b")		#lat_b and long_b are for destination
	long_b = kwargs.get("long_b")
	lat_c = kwargs.get("lat_c")		#c and d are for waypoint of latitude and longitude
